# Awesome Mainframes [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
 <!-- omit in toc -->
...
- [New Stanford Pascal](https://github.com/StanfordPascal/Pascal) - A modernized and actively maintained version of the Stanford Pascal compiler, which targets the IBM mainframe.  Currently maintained by Bernd Oppolzer.
...
- [H390-MVS](https://groups.io/g/H390-MVS) - Discussion on using the [MVS operating system](https://wotho.pebble-beach.ch/tk4-/) under the Hercules mainframe emulator.
...
- [KICKSforTSO](https://groups.io/g/KICKSforTSO) - Discussion on using [KICKS for TSO](http://www.kicksfortso.com/) (Free CICS substitute) on [MVS TK4-](https://wotho.pebble-beach.ch/tk4-/) under the Hercules mainframe emulator.
- [turnkey-mvs](https://groups.io/g/turnkey-mvs) - Discussion on using the [Turnkey 4- MVS 3.8j operating system](https://wotho.pebble-beach.ch/tk4-/) under the Hercules mainframe emulator.
...
- [The 1401 Room](https://rolffson.de/) - Rolf Sonnemann's virtual datacenter that approximately replicates the Computer History Museum's IBM 1401 exhibit. You can walk around, pick up punch cards, drop them into the card reader on the fully functional 1401, and more.
